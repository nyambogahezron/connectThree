...
export default function TutorialScreen() {
  ...
  const [miniBoard, setMiniBoard] = useState<(string | null)[][]>(() =>
    Array(MINI_BOARD_ROWS).fill(null).map(() => Array(MINI_BOARD_COLS).fill(null))
  );
  ...
  const resetDemo = () => {
    ...
    setMiniBoard(Array(MINI_BOARD_ROWS).fill(null).map(() => Array(MINI_BOARD_COLS).fill(null)));
    startStepAnimation();
  };
            ...
            {row.map((cell, colIndex) => (
              <TouchableOpacity
                ...
                style={[
                  styles.miniCell,
                  {
                    backgroundColor: cell === 'red' ? '#ef4444' : cell === 'yellow' ? '#fbbf24' : '#ffffff',
                  },
              ...
              >
                ...
                {currentStep === 1 && colIndex === 1 && rowIndex === 0 && (
                  <Animated.View style={[styles.droppingDisc, discAnimatedStyle]} />
                )}
