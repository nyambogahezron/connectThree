...
export const PersistentScoreDisplay: React.FC<PersistentScoreDisplayProps> = ({
  ...
  const unlockedAchievements = gameScore.achievements.filter(a => a.unlocked).length;
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainScoreSection}>
        <View style={styles.currentScore}>
          ...
          <Text style={styles.scoreText}>{formatScore(gameScore.currentScore)}</Text>
        </View>
      ...
      <View style={styles.breakdownSection}>
        <View style={styles.breakdownItem}>
          ...
          <Text style={styles.breakdownValue}>{formatScore(gameScore.basePoints)}</Text>
        </View>
        <View style={styles.breakdownItem}>
          <Text style={styles.breakdownLabel}>Bonus</Text>
          <Text style={styles.breakdownValue}>{formatScore(gameScore.bonusPoints)}</Text>
        </View>
        <View style={styles.breakdownItem}>
        ...
        <View style={styles.lifetimeSection}>
          <View style={styles.lifetimeItem}>
            ...
            <View style={styles.lifetimeText}>
              ...
              <Text style={styles.lifetimeValue}>{formatScore(gameScore.highScore)}</Text>
            </View>
          </View>
          ...
          <View style={styles.lifetimeItem}>
            ...
            <View style={styles.lifetimeText}>
              ...
              <Text style={styles.lifetimeValue}>{formatScore(gameScore.totalLifetimeScore)}</Text>
            </View>
          </View>
        </View>
      )}
